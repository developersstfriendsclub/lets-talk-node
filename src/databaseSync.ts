...
User.hasMany(Room, { foreignKey: 'sender_id', onDelete: 'CASCADE' });
User.hasMany(Room, { foreignKey: 'receiver_id', onDelete: 'CASCADE' });
Room.belongsTo(User, { foreignKey: 'sender_id', onDelete: 'CASCADE' });
Room.belongsTo(User, { foreignKey: 'receiver_id', onDelete: 'CASCADE' });

// Call associations
User.hasMany(Call, { foreignKey: 'sender_id', onDelete: 'CASCADE' });
User.hasMany(Call, { foreignKey: 'receiver_id', onDelete: 'CASCADE' });
Call.belongsTo(User, { foreignKey: 'sender_id', onDelete: 'CASCADE' });
Call.belongsTo(User, { foreignKey: 'receiver_id', onDelete: 'CASCADE' });
